...
import { idlFactory } from './assessment.did.js';
export { idlFactory } from './assessment.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ASSESSMENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./assessment.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the assessment canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./assessment.did.js")._SERVICE>}
 */
export const assessment = createActor(canisterId);
